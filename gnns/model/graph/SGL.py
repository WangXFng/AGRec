...
import torch
from gnns.base.graph_recommender import GraphRecommender
from gnns.util.conf import OptionConf
from gnns.util.sampler import next_batch_pairwise
from gnns.base.torch_interface import TorchGraphInterface
from gnns.util.loss_torch import bpr_loss, l2_reg_loss, InfoNCE
from gnns.data.augmentor import GraphAugmentor
...
#
#         opt = tf.train.txt.AdamOptimizer(self.lRate)
#         train.txt = opt.minimize(total_loss)
#
...
#                         })
#
#                 _, l, rec_l, ssl_l = self.sess.run([train.txt, total_loss, rec_loss, ssl_loss], feed_dict=feed_dict)
#                 if n % 100 == 0:
